...
export const TECHONE_FIN1_NATIVE_RULES: AuditRule[] = [
  ...
  },
  {
    ...
    tags: [
      ...
      "finance",
      "customer",
      "techone.financeone.fin1.customer_status_mismatch",
    ],
    enabledByDefault: true,
    sql: `SELECT c.CustomerCode AS subject_id,
                 c.CustomerName  AS customer_name,
  ...
  // ─── §19.3 — Sponsor / bursary integrity ─────────────────────────────
  {
    ...
    tags: [
      ...
      "finance",
      "sponsor",
      "techone.financeone.fin1.sponsor_relationship_expired",
    ],
    enabledByDefault: true,
    sql: `SELECT t.TransactionId     AS subject_id,
                 t.TransactionNumber AS invoice_number,
  ...
  // ─── §19.4 — Refund / credit-note integrity ──────────────────────────
  {
    ...
    tags: [
      ...
      "finance",
      "credit-note",
      "techone.financeone.fin1.credit_note_no_link",
    ],
    enabledByDefault: true,
    sql: `SELECT t.TransactionId     AS subject_id,
  ...
  // ─── §19.5 — GL coding & tax compliance ──────────────────────────────
  {
    ...
    tags: [
      ...
      "finance",
      "gl",
      "techone.financeone.fin1.invalid_chartfield_combination",
    ],
    enabledByDefault: true,
  ...
  // ─── §19.8 — Census / SLC / TCSI reporting hooks ─────────────────────
  {
    ...
    tags: [
      ...
      "finance",
      "census",
      "techone.financeone.fin1.census_outstanding_missing",
    ],
    enabledByDefault: true,
