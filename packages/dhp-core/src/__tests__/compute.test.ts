...
const baseInput: DhpComputeInput = {
  ...
  ruleResults: [
    { ruleId: 'HESA-TDP-001', entity: 'Student', family: 'FORMAT', severity: 'ERROR', failures: 5, totalEvaluated: 100 },
    { ruleId: 'HESA-TDP-010', entity: 'Student', family: 'CODING', severity: 'ERROR', failures: 2, totalEvaluated: 100 },
    { ruleId: 'HESA-TDP-030', entity: 'Engagement', family: 'REFERENTIAL', severity: 'ERROR', failures: 0, totalEvaluated: 80 },
  ],
};
