...
export const F08_duplicate_detection: AuditRule[] = [
  {
    ...
    description: "Two or more student records share identical surname, forenames, and date of birth",
    severity: "WARN",
    ...
    sql: `SELECT MIN(STU_CODE) AS subject_id,
         ...
         HAVING COUNT(*) > 1`,
    messageTemplate: "{{record_count}} students share name '{{surname}}, {{forenames}}' and DOB {{dob}} — possible duplicates"
  },
  {
    id: "F08-02",
    family: "F08",
    ...
    description: "Uses LLM to identify probable duplicate student records where name variants or data entry differences obscure exact matches. Always requires human approval before any merge action.",
    severity: "INFO",
    ucisa_benchmark_ref: "UCISA-DM-3.5",
    tags: ["duplicates", "ai", "sits"],
    enabledByDefault: false,
    promptTemplate: "Review these student records and identify any that are likely duplicates of each other, considering name variants, typos, and transposed dates of birth:\n\n{{context}}\n\nReturn a list of probable duplicate pairs with confidence scores.",
