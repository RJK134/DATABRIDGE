...
export const F10_award_integrity: AuditRule[] = [
  {
    ...
    description: "SAW record has a class of honours populated but the qualification aim is not an honours degree",
    severity: "ERROR",
    ...
    messageTemplate: "Award {{subject_id}}: class of honours '{{class_of_award}}' set but qualification aim '{{qual_aim}}' is not honours"
  },
  {
    id: "F10-02",
    family: "F10",
    ...
    description: "Enrolment has an end date and reason for ending implying completion, but no award record exists",
    severity: "WARN",
    ucisa_benchmark_ref: "UCISA-DM-3.8",
    tags: ["award", "hesa-df", "sits"],
    enabledByDefault: true,
    ...
    messageTemplate: "Enrolment {{subject_id}} (student {{student_id}}) completed but has no award record"
  }
];
