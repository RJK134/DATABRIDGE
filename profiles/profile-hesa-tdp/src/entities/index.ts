...
export const HESA_ENTITIES: HesaEntity[] = [
  {
    ...
    hesaRef: "STU",
    description:
      "Core student demographic and identifiers including HUSID, DOB, ethnicity, disability, domicile and nationality",
    mandatory: true,
    migrationOrder: 1,
  ...
  },
  {
    ...
    hesaRef: "ENG",
    description:
      "Links a student to an institution for a period of study. Contains engagement start/end dates and reason for ending",
    mandatory: true,
    migrationOrder: 2,
  ...
  },
  {
    ...
    hesaRef: "SCS",
    description:
      "Programme-level data: qualification aim, HECoS subjects, mode, FTE, funding body, year of study",
    mandatory: true,
    migrationOrder: 3,
  ...
  },
  {
    ...
    hesaRef: "MOD",
    description:
      "Module definition: identifier, title, HECoS subject, credit value and FHEQ credit level",
    mandatory: false,
    migrationOrder: 4,
  ...
  },
  {
    ...
    hesaRef: "LEA",
    description:
      "Destination data for students who left during the collection period. Links to Graduate Outcomes",
    mandatory: false,
    migrationOrder: 6,
  ...
  },
  {
    ...
    hesaRef: "ENP",
    description:
      "Entry qualifications held at point of entry. QUALENT3 codes, prior education, domicile at application",
    mandatory: false,
    migrationOrder: 7,
  ...
  },
  {
    ...
    hesaRef: "INP",
    description:
      "Period of study within the academic year. Location of study, teaching institution for franchised provision",
    mandatory: false,
    migrationOrder: 8,
...
export const MANDATORY_HESA_ENTITIES = HESA_ENTITIES.filter((e) => e.mandatory).map((e) => e.name);
