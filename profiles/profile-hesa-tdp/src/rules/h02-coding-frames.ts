...
export const H02_RULES: RuleDefinition[] = [
  {
    ...
    evaluate: (record) => {
      ...
      if (!val) return { pass: false, message: 'ETHNIC is missing. Ethnicity is mandatory for all Student records.' };
  ...
  },
  {
    ...
    evaluate: (record) => {
      ...
      if (!val) return { pass: false, message: 'DISABLE is missing. Disability is mandatory for all Student records.' };
  ...
  },
  {
    ...
    evaluate: (record) => {
      ...
      if (!val) return { pass: false, message: 'DOMICILE is missing. Domicile is mandatory for all Student records.' };
      if (!VALID_DOMICILE_CODES.has(val)) {
        return { pass: false, message: `DOMICILE value "${val}" is not a valid HESA DOMICILE code.` };
      }
      return { pass: true };
    },
  },
  ...
  },
  {
    ...
    evaluate: (record) => {
      ...
      if (!VALID_QUALENT3_CODES.has(val)) {
        return { pass: false, message: `QUALENT3 value "${val}" is not a valid HESA QUALENT3 code.` };
      }
      return { pass: true };
    },
  },
  {
    ...
    evaluate: (record) => {
      ...
      if (!VALID_FUNDCOMP_CODES.has(val)) {
        return { pass: false, message: `FUNDCOMP value "${val}" is not a valid HESA FUNDCOMP code.` };
      }
      return { pass: true };
    },
  },
