...
export const H07_RULES: RuleDefinition[] = [
  ...
  },
  {
    ...
    evaluate: (record) => {
      ...
      if (gross === undefined || gross === null || net === undefined || net === null) return { pass: true };
  ...
  },
  {
    ...
    description: 'Home undergraduate fee should not exceed the regulated maximum (£9,535 for 2025/26)',
    evaluate: (record) => {
